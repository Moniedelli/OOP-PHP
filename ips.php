...
<body>
    ...
    <div class="w3-top">
        <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
            ...
            <div class="w3-center w3-padding-16">Tabel IPS</div>
        </div>
    </div>
    ...
    <div class="container">
        <!-- judul -->
        <h1 class="mt-4">Data Index Prestasi Semester</h1>
        <figure>
        ...
        <a href="kelola_ips.php" type="button" class="btn btn-primary mb-3"> 
                    <i class="fa fa-plus">
                    </i> tambah data IPS
        </a>
...
<?php
    foreach($class->tampil_data_IPS() as $result) {
?>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="ubah_data_ips.php?kode_ips=<?php echo $result['kode_ips'] ?>" type="button"
                            ...
                            <a href="proses.php?i=delete&kode_ips=<?php echo $result['kode_ips'] ?>" type="button" 
