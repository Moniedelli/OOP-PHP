...
<body>
        ...
        <nav class="navbar navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand">Ubah Data jurusan</a> 
            </div>
        </nav>
        <br>
<div class="container"> 
        <form name="input" action="proses.php?j=update" method="POST"> 
                <!-- untuk input id jurusna -->
                <div class="mb-3 row">
                        <label for="id_jurusan" class="col-sm-2 col-form-label">ID Jurusan</label> 
                        <div class="col-sm-10">
                            <input type="text" name="id_jurusan" class="form-control" value="<?php echo $data ['id_jurusan']; ?>" readonly> 
                        </div>
                </div>

                <!-- untuk input nama jurusna -->
                <div class="mb-3 row">
